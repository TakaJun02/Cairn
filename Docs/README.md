...
| `23_ux_issues.md` | **再構築後**システムの UX 問題インベントリ(実機操作による所見、file:line付き) | 実機で通しの操作をしたとき |
| `24_architecture_as_built.md` | **実装されたアーキテクチャの解説**(バックエンド全体 + 旅程計画エージェント)。**実装と照合済み**で、文書との食い違いも §7 に記録 | 実装と文書を照合したとき |
